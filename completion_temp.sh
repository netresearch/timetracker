...
_complete_symfony() {
    ...
    local sfcomplete
    if sfcomplete=$(COMP_LINE="${COMP_LINE}" COMP_POINT="${COMP_POINT}" COMP_DEBUG="$COMP_DEBUG" CURRENT="$cword" /home/cybot/.symfony5/bin/symfony self:autocomplete 2>&1); then
