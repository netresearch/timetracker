...
*   **Nginx:** (`nginx:1.31-alpine` Docker image, see `compose.yml`) Web server and reverse proxy, serving static assets and forwarding PHP requests to the application container (PHP-FPM).
