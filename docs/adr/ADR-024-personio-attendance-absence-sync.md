...
**Status:** Accepted — fully implemented. P1 (attendance export) 2026-07-11; P2 (absence import) 2026-07-12; P3 (employee auto-match CLI + review UI, API/MCP run triggers) 2026-07-12.
**Date:** 2026-07-10
