...
class DefaultController extends BaseController
{
     ...
     * @throws \Doctrine\DBAL\DBALException
     * @throws \ReflectionException
     * @Route("/getAllProjects", name="_getAllProjects")
     */
    ...
    /**
     * @return Response
     * @Route("/getActivities", name="_getActivities")
     */
    ...
    /**
     * @return Response
     * @Route("/getHolidays", name="_getHolidays")
     */
     ...
     * @Route("/getTicketSummary/{ticket}", name="_getTicketTimeSummary")
     */
     ...
     *
     * @return Response
     * @Route("/getTicketSummaryForJira", name="_getTicketTimeSummaryJs")
     */
