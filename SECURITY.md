...
- A nonce-based Content Security Policy on every HTML response, currently in report-only mode ([`ContentSecurityPolicySubscriber`](src/EventSubscriber/ContentSecurityPolicySubscriber.php), [#739](https://github.com/netresearch/timetracker/issues/739))
