...
final class Version20260704_LastActivityIndexesAscLooseScan extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_entries_user_day ON entries (user_id, day)');
        $this->addSql('DROP INDEX IF EXISTS idx_entries_customer_day ON entries');
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_entries_customer_day ON entries (customer_id, day)');
        $this->addSql('DROP INDEX IF EXISTS idx_entries_project_day ON entries');
        $this->addSql('CREATE INDEX IF NOT EXISTS idx_entries_project_day ON entries (project_id, day)');
    }
