...
final class Version20260703_AddWebauthnCredentials extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users ADD COLUMN IF NOT EXISTS webauthn_user_handle VARCHAR(36) DEFAULT NULL');
        $this->addSql('CREATE UNIQUE INDEX IF NOT EXISTS UNIQ_users_webauthn_user_handle ON users (webauthn_user_handle)');
    }

    public function down(Schema $schema): void
    {
        $this->addSql('DROP INDEX UNIQ_users_webauthn_user_handle ON users');
        $this->addSql('ALTER TABLE users DROP COLUMN IF EXISTS webauthn_user_handle');
