...
if (!extension_loaded('mbstring')) {
    require_once dirname(__DIR__) . '/vendor/symfony/polyfill-mbstring/bootstrap.php';
}
...
if (file_exists(dirname(__DIR__) . '/vendor/symfony/phpunit-bridge/bootstrap.php')) {
    require_once dirname(__DIR__) . '/vendor/symfony/phpunit-bridge/bootstrap.php';
}
...
if (false !== getenv('PARATEST_PARALLEL') || isset($_ENV['PARATEST_PARALLEL'])) {
