...
When an incident does occur, it is important to report it promptly. To report a possible violation, please [open a private report](https://github.com/netresearch/timetracker/security/advisories/new) or use [GitHub Discussions](https://github.com/netresearch/timetracker/discussions) for non-sensitive matters.
...
For answers to common questions about Contributor Covenant, see the [FAQ](https://www.contributor-covenant.org/faq). Translations are provided at https://www.contributor-covenant.org/translations.
